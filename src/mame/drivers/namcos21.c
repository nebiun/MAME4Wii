...
#if 0
static INT32 ReadPointROMData( running_machine *machine, unsigned offset )
{
...
#endif
#if 0
static void TransmitWordToSlave( UINT16 data )
{
...
#endif
#if 0
static void TransferDspData( running_machine *machine )
{
...
#if 0
static UINT16 ReadWordFromSlaveInput( const address_space *space )
{
	UINT16 data = 0;
...
#endif
#if 0
static size_t GetInputBytesAdvertisedForSlave( running_machine *machine )
{
...
/************************************************************************************/
#if 0
static int InitDSP( running_machine *machine )
{
...
/************************************************************************************/
#if 0
static void RenderSlaveOutput( UINT16 data )
{
...
#endif
#if 0
static void winrun_flushpoly( void )
{
