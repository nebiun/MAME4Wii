...
static INPUT_PORTS_START( dynagear )
	...
	PORT_DIPSETTING(      0x0004, DEF_STR( Hard ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0x0030, 0x0000, DEF_STR( Lives ) )		PORT_DIPLOCATION( "DSW2:5,6" )
...
static INPUT_PORTS_START( keithlcy )
	...
	PORT_MODIFY("DSW2")	// IN1 - $210004
	PORT_DIPNAME( 0x000c, 0x0000, DEF_STR( Lives ) )		PORT_DIPLOCATION( "DSW2:3,4" )
...
static INPUT_PORTS_START( vasara )
	...
	PORT_DIPSETTING(      0x0001, DEF_STR( Hard ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0x000c, 0x0003, "Bomber Stock" )			PORT_DIPLOCATION("DSW2:3,4")
	PORT_DIPSETTING(      0x0000, "0" )
	PORT_DIPSETTING(      0x0004, "1" )
	PORT_DIPSETTING(      0x000c, "2" )
	PORT_DIPSETTING(      0x0008, "3" )
	PORT_DIPNAME( 0x0030, 0x0020, DEF_STR( Lives ))			PORT_DIPLOCATION("DSW2:5,6")
	PORT_DIPSETTING(      0x0000, "1" )
	PORT_DIPSETTING(      0x0010, "2" )
	PORT_DIPSETTING(      0x0030, "3" )
...
static INPUT_PORTS_START( vasara2 )
	...
	PORT_DIPSETTING(      0x0001, DEF_STR( Hard ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0x000c, 0x0008, DEF_STR( Lives ) )		PORT_DIPLOCATION("DSW2:3,4")
	PORT_DIPSETTING(      0x0000, "1" )
