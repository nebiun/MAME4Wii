...
static INPUT_PORTS_START( asterock )
	...
	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( Lives ) )					PORT_DIPLOCATION("SW:3,4")
...
static INPUT_PORTS_START( astdelux )
	...
	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( Lives ) )		PORT_DIPLOCATION("R5:3,4") /* Default is 2 or 3 depending on manual version */
