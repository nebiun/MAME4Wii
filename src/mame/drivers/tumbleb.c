...
static INPUT_PORTS_START( metlsavr )
	...
	PORT_DIPNAME( 0x000c, 0x0004, DEF_STR( Lives ) )            PORT_DIPLOCATION("SW1:6,5")
	PORT_DIPSETTING(      0x0000, "2" )
...
static INPUT_PORTS_START( suprtrio )
	...
	PORT_DIPNAME( 0x0018, 0x0018, DEF_STR( Lives ) )        PORT_DIPLOCATION("SW:5,4")
...
//  PORT_DIPSETTING(      0x0020, DEF_STR( 3C_1C ) )
	...
	PORT_DIPNAME( 0xc000, 0x8000, DEF_STR( Lives ) )            PORT_DIPLOCATION("SW2:2,1")   // See notes
	PORT_DIPSETTING(      0x0000, "2" )
	PORT_DIPSETTING(      0xc000, "3" )
	PORT_DIPSETTING(      0x4000, "4" )
...
static INPUT_PORTS_START( jumppop )
	...
	PORT_DIPSETTING(      0x1000, DEF_STR( Hard ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0xc000, 0x4000, DEF_STR( Lives ) )        PORT_DIPLOCATION("SWB:7,8")
	PORT_DIPSETTING(      0x8000, "1" )
	PORT_DIPSETTING(      0x0000, "2" )
	PORT_DIPSETTING(      0xc000, "3" )
	PORT_DIPSETTING(      0x4000, "4" )
