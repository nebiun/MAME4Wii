...
static INPUT_PORTS_START( ghouls )
	...
	PORT_START("DSWC")
	PORT_DIPNAME( 0x03, 0x00, DEF_STR( Lives ) )			PORT_DIPLOCATION("SW(C):1,2")
...
static INPUT_PORTS_START( willow )
	...
	PORT_START("DSWC")
	/* Standard Dip Switches */
	PORT_DIPNAME( 0x03, 0x00, DEF_STR( Lives ) ) PORT_CONDITION("DSWC", 0x80, PORTCOND_EQUALS, 0x80) PORT_DIPLOCATION("SW(C):1,2")
...
static INPUT_PORTS_START( mtwins )
	...
	PORT_START("DSWB")
	CPS1_DIFFICULTY_1( "SW(B)" )
	PORT_DIPNAME( 0x38, 0x00, DEF_STR( Lives ) )			PORT_DIPLOCATION("SW(B):4,5,6")
...
static INPUT_PORTS_START( 3wonders )
	...
	PORT_START("DSWB")
	PORT_DIPNAME( 0x03, 0x00, "Lives (Midnight Wanderers)" )		PORT_DIPLOCATION("SW(B):1,2")
	...
	PORT_DIPSETTING(    0x00, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0x30, 0x00, "Lives (Chariot)" )					PORT_DIPLOCATION("SW(B):5,6")
	...
	PORT_START("DSWC")
	PORT_DIPNAME( 0x03, 0x00, "Lives (Don't Pull)" )				PORT_DIPLOCATION("SW(C):1,2")
	PORT_DIPSETTING(    0x03, "1" )
	PORT_DIPSETTING(    0x02, "2" )
	PORT_DIPSETTING(    0x01, "3" )
	PORT_DIPSETTING(    0x00, "5" )
...
static INPUT_PORTS_START( cworld2j )
	...
	PORT_DIPNAME( 0xe0, 0xc0, DEF_STR( Lives ) )					PORT_DIPLOCATION("SW(B):6,7,8")
	PORT_DIPSETTING(    0x00, "1" )
