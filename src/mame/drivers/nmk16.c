...
static INPUT_PORTS_START( blkheart )
	...
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0xc0, 0x00, DEF_STR( Lives ) )		PORT_DIPLOCATION("SW1:2,1")
...
static INPUT_PORTS_START( tharrier )
	...
	PORT_DIPNAME( 0xc000, 0x0000, DEF_STR( Lives ) )	PORT_DIPLOCATION("SW1:2,1")
...
static INPUT_PORTS_START( hachamf )
	...
	PORT_DIPSETTING(    0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x00c0, 0x0080, DEF_STR( Lives ) )	PORT_DIPLOCATION("SW1:2,1")
...
static INPUT_PORTS_START( acrobatm )
	...
	PORT_DIPNAME( 0xc0, 0x00, DEF_STR( Lives ) )		PORT_DIPLOCATION("SW2:2,1")
	PORT_DIPSETTING(    0x40, "2" )
	PORT_DIPSETTING(    0xc0, "3" )
	PORT_DIPSETTING(    0x80, "4" )
	PORT_DIPSETTING(    0x00, "5" )
...
static INPUT_PORTS_START( bioship )
	...
	PORT_DIPNAME( 0x00C0, 0x0040, DEF_STR( Lives ) )	PORT_DIPLOCATION("SW1:2,1")
...
static INPUT_PORTS_START( tdragonb )
	...
	PORT_START("DSW1")
	PORT_DIPNAME( 0x0003, 0x0001, DEF_STR( Lives ) )	PORT_DIPLOCATION("SW1:1,2")
	PORT_DIPSETTING(      0x0000, "1" )
...
static INPUT_PORTS_START( macross )
	...
	PORT_DIPSETTING(    0x20, DEF_STR( Hard ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0xc0, 0x80, DEF_STR( Lives ) )		PORT_DIPLOCATION("SW1:2,1")
...
static INPUT_PORTS_START( tdragon2 )
	...
	PORT_DIPSETTING(    0x20, DEF_STR( Hard ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0xc0, 0x80, DEF_STR( Lives ) )		PORT_DIPLOCATION("SW1:1,2")
	PORT_DIPSETTING(    0x00, "1" )
	PORT_DIPSETTING(    0x40, "2" )
	PORT_DIPSETTING(    0xc0, "3" )
	PORT_DIPSETTING(    0x80, "4" )
...
static INPUT_PORTS_START( stagger1 )
	...
	PORT_DIPSETTING(      0x0020, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x00c0, 0x0040, DEF_STR( Lives ) )		PORT_DIPLOCATION("SW2:2,1")
	PORT_DIPSETTING(      0x0000, "1" )
...
static INPUT_PORTS_START( redhawkb )
	...
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0020, DEF_STR( On ) )
	PORT_DIPNAME( 0x00c0, 0x0080, DEF_STR( Lives ) )		PORT_DIPLOCATION("SW2:2,1")
