...
static INPUT_PORTS_START( astinvad )
	...
	PORT_MODIFY("IN1")
	PORT_DIPNAME( 0x01, 0x01, DEF_STR( Lives ) )            PORT_DIPLOCATION("SW:2")
...
static INPUT_PORTS_START( spaceint )
	...
	PORT_DIPNAME( 0x06, 0x02, DEF_STR( Lives ) )            /* code at 0x0d4a */
	PORT_DIPSETTING(    0x00, "3" )
...
static INPUT_PORTS_START( spaceinj )
	...
	PORT_MODIFY("IN1")
	PORT_DIPNAME( 0x06, 0x02, DEF_STR( Lives ) )            /* code at 0x0d37 */
	PORT_DIPSETTING(    0x00, "3" )
	PORT_DIPSETTING(    0x02, "5" )
