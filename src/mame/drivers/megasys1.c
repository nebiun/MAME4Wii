...
static INPUT_PORTS_START( 64street )
	...
	PORT_DIPNAME( 0x0060, 0x0000, DEF_STR( Lives ) )
...
static INPUT_PORTS_START( astyanax )
	...
	PORT_DIPNAME( 0x0018, 0x0000, DEF_STR( Lives ) )
...
static INPUT_PORTS_START( edf )
	...
	PORT_DIPNAME( 0x0008, 0x0000, DEF_STR( Lives ) )
...
static INPUT_PORTS_START( rodland )
	...
	PORT_DIPNAME( 0x000c, 0x0008, DEF_STR( Lives ) )
