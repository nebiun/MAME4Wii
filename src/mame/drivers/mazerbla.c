...
//  bitmap_fill(bitmap,NULL,0);
	...
	copybitmap_trans(bitmap,tmpbitmaps[2],0,0,0,0,cliprect,color_base);
	copybitmap_trans(bitmap,tmpbitmaps[1],0,0,0,0,cliprect,color_base); //haircross
	copybitmap_trans(bitmap,tmpbitmaps[0],0,0,0,0,cliprect,color_base); //sprites
	return 0;
}
...
static INPUT_PORTS_START( mazerbla )
	...
	PORT_DIPNAME( 0x30, 0x30, "Number of points for extra frezze & first life" )
	PORT_DIPSETTING(	0x30, "20000" )
	PORT_DIPSETTING(	0x20, "25000" )
	PORT_DIPSETTING(	0x10, "30000" )
	PORT_DIPSETTING(	0x00, "35000" )
	PORT_DIPNAME( 0xc0, 0xc0, "Number of points for extra life other than first" )
