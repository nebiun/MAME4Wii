...
static INPUT_PORTS_START( vangrd2 )
	...
	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( Lives ) )			PORT_DIPLOCATION("DSW1:7,8")
	PORT_DIPSETTING(    0x00, "1" )
...
static INPUT_PORTS_START( madcrash )
	...
	PORT_DIPNAME( 0x04, 0x00, DEF_STR( Lives ) )		PORT_DIPLOCATION("DSW1:3")
...
static INPUT_PORTS_START( athena )
	...
	PORT_DIPNAME( 0x08, 0x00, DEF_STR( Lives ) )            PORT_DIPLOCATION("DSW1:4")
