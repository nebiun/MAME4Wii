...
//	ysizemask = ysize - 1;
	...
	{
		case 0: xlinesize = xsize / 2; break;			// xpixelsize = 0; 
		case 1: xlinesize = xsize; break;				// xpixelsize = 1; 
		case 2: case 3: xlinesize = xsize * 2; break;	// xpixelsize = 2; 
		case 4: xlinesize = xsize * 4; break;			// xpixelsize = 4;
	}
