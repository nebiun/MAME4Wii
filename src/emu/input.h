...
enum _input_item_id
{
	...
	ITEM_ID_XAXIS,
#else
	ITEM_ID_XAXIS = ITEM_ID_FIRST_VALID,
#endif
	ITEM_ID_YAXIS,
	ITEM_ID_ZAXIS,
	ITEM_ID_RXAXIS,
...
#else
	KEYCODE_A = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions	
	KEYCODE_B = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_C = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_D = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_E = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_F = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_G = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_H = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazc
	KEYCODE_I = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazc
	KEYCODE_J = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_K = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazc
	KEYCODE_L = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_M = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazc
	KEYCODE_N = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// alpha68k
	KEYCODE_O = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazc
	KEYCODE_P = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// thayers
	KEYCODE_Q = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_R = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazc
	KEYCODE_S = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_T = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_U = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_V = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_W = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_X = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// alpha68k
	KEYCODE_Y = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazg
	KEYCODE_Z = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// alpha68k
	KEYCODE_0 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// firebeat
	KEYCODE_1 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_2 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_3 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// albazg
	KEYCODE_4 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_5 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_6 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_7 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_8 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// 86lions
	KEYCODE_9 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),		// midyunit
	KEYCODE_F1 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// equites
	KEYCODE_F2 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// fromanc2
//	KEYCODE_F3 = 
	KEYCODE_F4 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// berzerk
	KEYCODE_F5 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// berzerk
	KEYCODE_F6 = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// firetrk
//	KEYCODE_F7 = 
//	KEYCODE_F8 = 
//	KEYCODE_F9 =
//	KEYCODE_F10 = 
...
//	KEYCODE_ESC =
//	KEYCODE_TILDE =
	KEYCODE_MINUS = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// playch10
	KEYCODE_EQUALS = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// playch10
	KEYCODE_BACKSPACE = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// thayers
//	KEYCODE_TAB = 
//	KEYCODE_OPENBRACE = 
//	KEYCODE_CLOSEBRACE = 
	KEYCODE_ENTER = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// mcr3
//	KEYCODE_COLON = 
//	KEYCODE_QUOTE = 
	KEYCODE_BACKSLASH = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// vsnes
//	KEYCODE_BACKSLASH2 = 
	KEYCODE_COMMA = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// relief
	KEYCODE_STOP = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// cinemat
	KEYCODE_SLASH = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// cinemat
	KEYCODE_SPACE = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// mitchell
	KEYCODE_INSERT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// kickgoal
	KEYCODE_DEL = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// kickgoal
//	KEYCODE_HOME = 
//	KEYCODE_END =
	KEYCODE_PGUP = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// calchase
	KEYCODE_PGDN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// calchase
	KEYCODE_LEFT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus	
	KEYCODE_RIGHT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus	
	KEYCODE_UP = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus	
	KEYCODE_DOWN = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus	
	KEYCODE_0_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus
	KEYCODE_1_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_2_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_3_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_4_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_5_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus
	KEYCODE_6_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_7_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_8_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_9_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// balsente
	KEYCODE_SLASH_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// deshoros
	KEYCODE_ASTERISK = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// esripsys
	KEYCODE_MINUS_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus
	KEYCODE_PLUS_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus	
	KEYCODE_DEL_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// darkhors
	KEYCODE_ENTER_PAD = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// orbit
//	KEYCODE_PRTSCR =
//	KEYCODE_PAUSE =
	KEYCODE_LSHIFT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// midzeus
//	KEYCODE_RSHIFT = 
	KEYCODE_LCONTROL = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// konamigx
	KEYCODE_RCONTROL = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// toobin
	KEYCODE_LALT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// mitchell
	KEYCODE_RALT = STANDARD_CODE(JOYSTICK, 0, SWITCH, NONE, BUTTON11),	// darkhors
//	KEYCODE_SCRLOCK = 
//	KEYCODE_NUMLOCK = 
//	KEYCODE_CAPSLOCK = 
//	KEYCODE_LWIN = 
